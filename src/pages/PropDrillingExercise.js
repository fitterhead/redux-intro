...
const RootComponent = (props) => {
  ...
  const addProductToCart = (newProduct) => {
    const newProductsList = cart.products.map((product) => {
    ...
    let newTotalPrice = cart.totalPrice + newProduct.price;
    console.log(newProductsList, "newProductList");
...
const ProductPage = (props) => {
  console.log(props, "productPageprop");
  return (
    <WrapperBox>
      <Typography
        p="0.5rem"
...
const ProductOne = (props) => {
  console.log(props, "productoneprops");
  console.log(props.product, "Product1");
  return (
    <WrapperBox>
      <Typography
        p="0.5rem"
